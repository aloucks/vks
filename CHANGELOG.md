...
### Changed
 ...
 - `instance_proc_addr_loader::{Core, CoreGlobal}` and `device_proc_addr_loader::Core` were renamed
   to `Vk` and `VkGlobal` as well for consistency.
...
### Added
 - Vulkan 1.0.54, 1.0.55, 1.0.56, 1.0.57
